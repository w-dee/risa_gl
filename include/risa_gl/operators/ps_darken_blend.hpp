#ifndef RISA_PS_DARKEN_BLEND_HPP_
#define RISA_PS_DARKEN_BLEND_HPP_
...
namespace risa_gl
{
	namespace operators
	{
		 ...
		 */
		// {{{ ps_darken_blend_operator
		class ps_darken_blend_operator
		{
		private:
			typedef photoshop_blend<darken_blend_save_source_alpha_operator,
									alpha_blend_operator>
			ps_darken_blend_operator_type;
			ps_darken_blend_operator_type blender;
		public:
			ps_darken_blend_operator():
				blender()
			{}
		 ...
		 */
		// {{{ ps_darken_blend_save_destination_alpha_operator
		class ps_darken_blend_save_destination_alpha_operator
		{
		private:
...
#endif /* RISA_PS_DARKEN_BLEND_HPP_ */
