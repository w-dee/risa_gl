...
class alpha_blend_operator_test : public CppUnit::TestFixture
{
	...
	CPPUNIT_TEST(alpha_blend_transmissive_destination_test);
	CPPUNIT_TEST(alpha_blend_additive_destination_operator_test);
...
public:
	void alpha_blend_additive_destination_operator_test()
	{
		 ...
		 */
		operators::alpha_blend_additive_destination_operator oper;
		 ...
		 */
		oper(src.begin(), dest.begin(), result.begin());
		CPPUNIT_ASSERT(range<int>(result.begin()->get_red(), 191, 1));
		CPPUNIT_ASSERT(range<int>(result.begin()->get_green(), 191, 1)); 
		CPPUNIT_ASSERT(range<int>(result.begin()->get_blue(), 191, 1));
		CPPUNIT_ASSERT(range<int>(result.begin()->get_alpha(), 130, 1));
	}

	void alpha_blend_transmissive_destination_test()
	{
		using namespace risa_gl;
		 ...
		 * 1.0
		 */
		operators::alpha_blend_transmissive_destination_operator oper;
		oper(src.begin(), dest.begin(), result.begin());
		CPPUNIT_ASSERT(result.begin()->get_red() == 64);
		CPPUNIT_ASSERT(result.begin()->get_green() == 64); 
		CPPUNIT_ASSERT(result.begin()->get_blue() == 64);
		 ...
		 */
		oper(src.begin(), dest.begin(), result.begin());
		CPPUNIT_ASSERT(range<int>(result.begin()->get_red(), 64, 1));
		CPPUNIT_ASSERT(range<int>(result.begin()->get_green(), 64, 1));
		CPPUNIT_ASSERT(range<int>(result.begin()->get_blue(), 64, 1));
		CPPUNIT_ASSERT(range<int>(result.begin()->get_alpha(), 130, 1));
	}
