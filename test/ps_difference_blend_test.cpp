...
#include <risa_gl/operators/ps_difference_blend.hpp>
...
public:
	...
	void ps5_difference_blend_test()
	{
		...
		CPPUNIT_ASSERT(result.begin()->get_red() == 75);
		CPPUNIT_ASSERT(result.begin()->get_green() == 66);
		CPPUNIT_ASSERT(result.begin()->get_blue() == 66);
