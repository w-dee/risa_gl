...
#include <risa_gl/operators/ps_div_blend.hpp>
...
class ps_div_blend_operator_test : public CppUnit::TestFixture
{
	...
	CPPUNIT_TEST(ps5_div_blend_test);
	CPPUNIT_TEST(ps5_div_blend_save_destination_alpha_test);
...
public:
	...
	void ps5_div_blend_test()
	{
		 ...
		 * (255, 70, 70)
		 */
		operators::ps5_div_blend_operator oper;
		oper(src.begin(), dest.begin(), result.begin());
	...
	void ps5_div_blend_save_destination_alpha_test()
	{
		using namespace risa_gl;
		...
		operators::ps5_div_blend_save_destination_alpha_operator oper;
		oper(src.begin(), dest.begin(), result.begin());
